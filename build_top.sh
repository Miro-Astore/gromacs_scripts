...
#gmx pdb2gmx -vsite hydrogens -f ATP.pdb -o ATP.gro -ff charmm36-mar2019 -ter  -water tip3p -p topol.top 
#gmx pdb2gmx -vsite hydrogens -f ionized.pdb -o ionized.gro -ff charmm36-mar2019 -ter  -water tip3p -p topol.top 
gmx pdb2gmx -f ionized.pdb -o ionized.gro -ff charmm36-mar2019 -ter  -water tip3p -p topol.top 
